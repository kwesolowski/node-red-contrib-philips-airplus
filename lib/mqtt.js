...
const { circuitBreaker, ConsecutiveBreaker, BrokenCircuitError } = require('cockatiel');
const {
    TOPIC_SHADOW_GET,
...
function createMqttClient({
    ...
    const connectionBreaker = circuitBreaker(async () => await connectInternal(), {
    ...
    async function connect() {
        return await connectionBreaker.execute();
    }
