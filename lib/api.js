...
function createApiClient({ fetchFn = fetch } = {}) {
     ...
     * @param {string} userId - Philips user ID (PHILIPS:uuid format)
    ...
    async function getToken(userId) {
        ...
        const signature = generateSignature(MXCHIP_APP_ID, timestamp, userId);
    ...
    return {
        ...
        async listDevices(userId) {
            ...
            return Array.isArray(data) ? data.map(parseDevice) : [];
        },
