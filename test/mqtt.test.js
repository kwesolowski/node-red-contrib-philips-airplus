...
describe('mqtt', () => {
    ...
    describe('createMqttClient', () => {
        ...
        it('publishes to shadow/get to request state', async () => {
            ...
            expect(published.some((p) => p.topic === '$aws/things/dev-123/shadow/get')).toBe(
                true
            );
            ...
            mockMqttLib
                .getLastClient()
                .simulateMessage('$aws/things/dev-123/shadow/get/accepted', {
        ...
        it('publishes desired state to shadow/update', async () => {
            ...
            const published = mockMqttLib.getLastClient().published;
            const updateMsg = published.find(
                (p) => p.topic === '$aws/things/dev-123/shadow/update'
            );
            ...
            mockMqttLib
                .getLastClient()
                .simulateMessage('$aws/things/dev-123/shadow/update/accepted', {
        ...
        it('calls onStateChange for shadow delta messages', async () => {
            ...
            mockMqttLib
                .getLastClient()
                .simulateMessage('$aws/things/dev-123/shadow/update/delta', {
                    state: { powerOn: true },
                });
        ...
        it('rejects request on shadow/get/rejected', async () => {
            ...
            mockMqttLib
                .getLastClient()
                .simulateMessage('$aws/things/dev-123/shadow/get/rejected', {
